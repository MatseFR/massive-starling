 ...
 * @author Matse
 */
class ClipContainer extends ContainerBase
{
	#if flash
	private var _datas:Vector<Clip>;
	#else
	private var _datas:Array<Clip>;
	#end
	
	#if flash
	public function new(datas:Vector<Clip> = null) 
	#else
	public function new(datas:Array<Clip> = null) 
	#end
	{
		super();
		this._datas = datas;
		#if flash
		if (this._datas == null) this._datas = new Vector<Clip>();
		#else
		if (this._datas == null) this._datas = new Array<Clip>();
		#end
	}
	
	public function addChild(child:Clip):Void
	{
		this._datas[this._datas.length] = child;
	}
	
	public function addChildAt(child:Clip, index:Int):Void
	{
		#if flash
	...
	public function addChildren(children:Array<Clip>):Void
	{
	...
	public function addChildrenAt(children:Array<Clip>, index:Int):Void
	{
		--index;
		var count:Int = children.length;
		for (i in 0...count)
	...
	public function getChildAt(index:Int):Clip
	{
		return this._datas[index];
	}
	
	public function getChildIndex(child:Clip):Int
	{
	...
	public function removeChildren(children:Array<Clip>):Void
	{
		var count:Int = children.length;
		for (i in 0...count)
		{
